...
# The correct URI that should be used
correct_uri = "mongodb+srv://sousaigor:zRFWDklR6NiE3UOI@cluster0.qjyol.mongodb.net/kaefer_approval?retryWrites=true&w=majority&appName=Cluster0"

# A test URI that might be wrong (points to test database)
wrong_uri = "mongodb+srv://sousaigor:zRFWDklR6NiE3UOI@cluster0.qjyol.mongodb.net/test?retryWrites=true&w=majority&appName=Cluster0"
